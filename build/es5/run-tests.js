...
// optionals
var ngAnnotateAdfPlugin = require("./optionals/angular-dashboard-framework.js");
...
function run(ngAnnotate) {
    ...
    var original_wrapped = slurp("tests/es6.original.js");
    var annotated_wrapper = ngAnnotate(original_wrapped, {add: true, es6: true}).src;
    ...
    var annotatedSourcemaps = ngAnnotate(compiledSourcemaps.js, {remove: true, add: true, map: { sourceRoot: "/source/root/dir" }});
    ...
    var combinedSourcemaps = ngAnnotate(inlinedCompiledSourcemaps, {remove: true, add: true, map: { inline: true, inFile: "sourcemaps.js", sourceRoot: "/source/root/dir" }});
    ...
    var adfAnnotated = ngAnnotate(adf, {add: true, plugin: [ngAnnotateAdfPlugin]}).src;
